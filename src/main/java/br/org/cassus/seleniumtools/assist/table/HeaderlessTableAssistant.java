...
public class HeaderlessTableAssistant extends AbstractTableAssistant {
	...
	/**
	 * HeaderlessTableAssistant should be used whenever you don't have any headers on your table and contents start your first row.
	 * 
	 * @param  table the selenium table WebElement you need help dealing with.
	 * **/
	public HeaderlessTableAssistant(WebElement table) {
		super(table);
	}
}
